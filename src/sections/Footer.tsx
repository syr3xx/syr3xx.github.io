...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0C0C0C] border-t border-[#D7E2EA]/10 px-5 sm:px-8 md:px-10 py-6 sm:py-8">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-[#D7E2EA]/70 text-xs sm:text-sm uppercase tracking-wider">
